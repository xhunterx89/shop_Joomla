...
<thead>
  <tr>
    ...
    <th width = "15%">
           ...
           &nbsp;<img style = "cursor:pointer" src = "<?php print $this->image_path ?>/images/save.png" title = "<?php print _JSHOP_UPDATE_CART ?>" alt = "<?php print _JSHOP_UPDATE_CART ?>" onclick = "document.updateCart.submit();" />
  ...
  <tr id = "checkout">
    <td width = "50%" class = "td_1">
       <a href = "<?php print $this->href_shop ?>" >
         <img src = "<?php print $this->image_path ?>/images/arrow_left.png" alt = "<?php print _JSHOP_BACK_TO_SHOP ?>" />
         <?php print _JSHOP_BACK_TO_SHOP ?>
       </a>
    </td>
    <td width = "50%" class = "td_2">
       <a href = "<?php print $this->href_checkout ?>" class="button">
         <?php print _JSHOP_CHECKOUT ?>
         <img src = "<?php print $this->image_path ?>/images/checkout.png" alt = "<?php print _JSHOP_CHECKOUT ?>" />
       </a>
    </td>
  </tr>
</table>
...
<table class = "jshop jshop_rebatt">
  <tr>
    <td>
      <?php print _JSHOP_RABATT ?>
      <input type = "text" class = "inputbox" name = "rabatt" value = "" />
      <input type = "submit" class = "button grey" value = "<?php print _JSHOP_RABATT_ACTIVE ?>" />
    </td>
  </tr>
</table>
</form>
