...
$labels[$i]='<div class="label_text">
                ...
                <hass><a href="'.$links[$i].'" target="'.$linktarget.'">'.$labels[$i].'</a></hass>'.$descs[$i].'
...
.label_skitter hass,.label_skitter hass a{
