...
$content_inside_width 			= 945 - $layout_leftcol_width; 

$middle_col_width 				= $content_inside_width - $layout_rightcol_width - 15; 
...
function countModules( $module_name = ""){
		...
		if (!($clean = $cache->get($cacheid))) {
			...
			$query->where('e.element LIKE "'.$module_name.'%"');
